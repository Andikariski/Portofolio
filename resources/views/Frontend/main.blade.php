...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Andhika Risky</h1>
      <p>I'm <span class="typed" data-typed-items="Graphic Designer, Web Developer"></span></p>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <img src="{{ url('FrontEnd/assets/img/profile-img.jpg') }}" class="img-fluid" alt="">
              <h4><a href="">Pudatin</a></h4>
              <p>Aplikasi pengolahan data penduduk, yang dibuat dengan framework Laravel 8</p>

              <hr>
              <div class="text-center mt-2">
                <a href="http://kampungngajaran.online/" class="twitter" target="_blank"><i class="bx bx-world bx-sm"></i></a>
                <a href="https://github.com/Andikariski/PUSDATIN" class="twitter" target="_blank"><i class="bx bxl-github bx-sm"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <hr>
              <div class="text-center mt-2">
                <a href="#" class="twitter"><i class="bx bx-world bx-sm"></i></a>
                <a href="#" class="twitter"><i class="bx bxl-github bx-sm"></i></a>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="copyright">
        &copy; Copyright <strong><span><a href="{{ route('login') }}">Andika Riski</span></strong></a>. All Rights Reserved
      </div>
      <div class="credits">
